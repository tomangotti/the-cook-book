...
const EditCollectionForm = () => {
    ...
    useEffect(() => {
        // Fetch collection data and populate form fields
        // Example code:
        const fetchCollectionData = async () => {
            // Fetch collection data based on params.id
            const collectionData = await fetchCollection(params.id);
            setName(collectionData.name);
            setDescription(collectionData.description);
            setSelectedRecipes(collectionData.recipes);
        };
    ...
    const handleEditCollection = async () => {
        ...
        const response = await updateCollection(collection, params.id);
        if(!response) {
        ...
        <SafeAreaView>
            ...
            <View style={{
                ...
                <View style={{alignItems: "center", width: "100%"}} >
                    ...
                    {/* Render recipe selection checkboxes */}
                </View>
                <Button title="Save Collection" onPress={handleEditCollection} />
            </View>
            </ScrollView>
        </SafeAreaView>
    );
